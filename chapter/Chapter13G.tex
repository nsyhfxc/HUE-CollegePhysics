...
\begin{OldFigure}[完全偏振光]
    \begin{OldFigureSub}[水平偏振]
        \inputfigure[]{Chapter13G_Figure02}
    \end{OldFigureSub}\vspace{0.5cm}
    \begin{OldFigureSub}[垂直偏振]
        \inputfigure[]{Chapter13G_Figure01}
    \end{OldFigureSub}
\end{OldFigure}
...
\begin{OldFigure}[自然光]
    \inputfigure{Chapter13G_Figure03}
\end{OldFigure}
...
\begin{OldFigure}[部分偏振光]
    \begin{OldFigureSub}[水平部分偏振]
        \inputfigure[]{Chapter13G_Figure05}
    \end{OldFigureSub}\vspace{0.5cm}
    \begin{OldFigureSub}[垂直部分偏振]
        \inputfigure[]{Chapter13G_Figure04}
    \end{OldFigureSub}
\end{OldFigure}
...
\begin{OldFigure}[起偏器]
    \inputfigure[]{Chapter13G_Figure06}
\end{OldFigure}
...
\end{itemize}
\begin{OldFigure}[检偏器]
    \begin{OldFigureSub}[最亮]
        \inputfigure[]{Chapter13G_Figure07}
    \end{OldFigureSub}\vspace{0.5cm}
    \begin{OldFigureSub}[最暗]
        \inputfigure[]{Chapter13G_Figure08}
    \end{OldFigureSub}
\end{OldFigure}
...
\begin{OldFigure}[反射和折射中的偏振现象]
    \inputfigure[]{Chapter13G_Figure09}
\end{OldFigure}
...
\begin{OldBoxLaw}[布儒斯特定律]
    当反射光和折射光垂直时，反射光将变为完全偏振光。
\end{OldBoxLaw}
定义反射光变为完全偏振光时的那一特殊入射角，定义为\uwave{布儒斯特角}，布儒斯特定律只告诉我们布儒斯特角对应的是反射光和折射光垂直的情形，并没有给出布儒斯特角的计算公式。

\begin{OldFigure}[布儒斯特角]
    \begin{OldFigureSub}[光由空气射向玻璃]
        \inputfigure[scale=0.85]{Chapter13G_Figure10}
    \end{OldFigureSub}\hspace{0.2cm}
    \begin{OldFigureSub}[光由玻璃射向空气]
        \inputfigure[scale=0.85]{Chapter13G_Figure11}
    \end{OldFigureSub}
\end{OldFigure}\vspace{0.2cm}

\begin{OldBoxFormula}[布儒斯特角]
