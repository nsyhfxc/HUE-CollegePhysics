...
\begin{OldFigure}[双缝干涉]
    \begin{OldFigureSub}[双缝干涉的装置图]
        \inputfigure[scale=0.75]{Chapter13C_Figure02}
    \end{OldFigureSub}
    \hspace{0.5cm}
    \begin{OldFigureSub}[双缝干涉的原理图]
        \inputfigure[scale=0.75]{Chapter13C_Figure03}
    \end{OldFigureSub}
\end{OldFigure}
