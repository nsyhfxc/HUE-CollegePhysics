...
\begin{Table}[理想气体的特殊变化过程]{cllcll}
...
\begin{Figure}[四类准静态过程的曲线]
    \includegraphics[scale=1]{build/Chapter02C_01.fig.pdf}
\end{Figure}
...
\begin{Table}[四类准静态过程的特点对比]{|l|l|c|c|c|c|c|c|}
