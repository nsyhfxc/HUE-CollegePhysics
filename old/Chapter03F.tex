...
\begin{Figure}[光栅]
    \includegraphics[scale=0.9]{build/Chapter03F_10.fig.pdf}
\end{Figure}

那么，光栅衍射的结果与单缝衍射的结果有何不同？
\begin{Table}[光栅衍射的成因]{|c|c|}
<光缝数量$N=2$&光缝数量$N=4$\\>
\xcell<c>[0.5ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_05.fig.pdf}}
&
\xcell<c>[0.5ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_06.fig.pdf}}\\
\hlinelig
\mc{2}(|c|){光栅衍射的结果}\\
\hlinemid
\xcell<c>[0.5ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_09.fig.pdf}}
&
\xcell<c>[0.5ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_09.fig.pdf}}\\
\hlinelig
\mc{2}(|c|){衍射部分}\\
\hlinemid
\xcell<c>[0.5ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_07.fig.pdf}}
&
\xcell<c>[0.5ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_08.fig.pdf}}\\
\hlinelig
\mc{2}(|c|){干涉部分}\\
\end{Table}
...
{%
    \xcell<c>[0.2ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_02_#1.fig.pdf}}
    &
    \xcell<c>[0.2ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_01_#1.fig.pdf}}\\*
    \xcell<c>[0.0ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_04_#1.fig.pdf}}
    &
    \xcell<c>[0.0ex][0.0ex]{\includegraphics[scale=0.6]{build/Chapter03F_03_#1.fig.pdf}}\\*
    \hlinelig
    \mc{2}(|c|){$N=#1$}\\
    \hlinemid
}

\begin{TableLong}[光栅衍射]{|c|c|}
