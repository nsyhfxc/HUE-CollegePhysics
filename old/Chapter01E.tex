...
\begin{Figure}[麦克斯韦分布律]
    \begin{FigureSub}[速率分布]
        \includegraphics{build/Chapter01E_01.fig.pdf}
    \end{FigureSub}
    \hspace{0.5cm}
    \begin{FigureSub}[速度分布]
        \includegraphics{build/Chapter01E_02.fig.pdf}
    \end{FigureSub}
\end{Figure}
...
\end{itemize}
\begin{Figure}[理想气体分子的三种统计速率]
    \includegraphics[scale=0.8]{build/Chapter01E_03.fig.pdf}
\end{Figure}
