...
\begin{Figure}[光的反射定律与折射定律]
    \begin{FigureSub}[光的反射]
        \includegraphics[scale=1.2]{build/Chapter03D_01.fig.pdf}
    \end{FigureSub}
    \hspace{0.5cm}
    \begin{FigureSub}[光疏至光密的折射]
        \includegraphics[scale=1.2]{build/Chapter03D_02.fig.pdf}
    \end{FigureSub}
    \hspace{0.5cm}
    \begin{FigureSub}[光密至光疏的折射]
        \includegraphics[scale=1.2]{build/Chapter03D_03.fig.pdf}
    \end{FigureSub}
\end{Figure}
...
\begin{Figure}[薄膜干涉]
    \includegraphics[scale=0.9]{build/Chapter03D_04.fig.pdf}
\end{Figure}
...
\begin{Table}[薄膜干涉的界面反射条件]{|c|c|c|c|}
<\mc{2}(|c|){界面反射条件相同}&\mc{2}(|c|){界面反射条件不同}\\>
\xcell<c>{\includegraphics[scale=0.8]{build/Chapter03D_05.fig.pdf}}&
\xcell<c>{\includegraphics[scale=0.8]{build/Chapter03D_06.fig.pdf}}&
\xcell<c>{\includegraphics[scale=0.8]{build/Chapter03D_07.fig.pdf}}&
\xcell<c>{\includegraphics[scale=0.8]{build/Chapter03D_08.fig.pdf}}\\
...
\begin{Figure}[劈形膜的干涉原理]
    \includegraphics[scale=0.9]{build/Chapter03D_11.fig.pdf}
\end{Figure}

\begin{BoxFormula}[劈形膜干涉的光程差]
...
\begin{Figure}[劈形膜的干涉条纹]
    \begin{FigureSub}[界面反射条件相同]
        \includegraphics[scale=0.95]{build/Chapter03D_10.fig.pdf}
    \end{FigureSub}
    \hspace{0.5cm}
    \begin{FigureSub}[界面反射条件不同]
        \includegraphics[scale=0.95]{build/Chapter03D_09.fig.pdf}
    \end{FigureSub}  
\end{Figure}
\begin{BoxProperty}[劈形膜在反射条件相同时的干涉条纹]
...
\begin{BoxProperty}[劈形膜在反射条件不同时的干涉条纹]
...
\begin{Proof}
    ...
    \begin{Figure}[牛顿环的仪器图]
        \includegraphics[scale=0.75]{build/Chapter03D_13.fig.pdf}
    \end{Figure}
...
\begin{Figure}[牛顿环的干涉图样]
    \includegraphics[scale=0.75]{build/Chapter03D_12.fig.pdf}
\end{Figure}

牛顿环的一个常见的用途就是用于测定透镜的曲率半径$R$，其利用的是\xrefpeq{1}。
\begin{BoxFormula}[牛顿环测量透镜曲率半径]
